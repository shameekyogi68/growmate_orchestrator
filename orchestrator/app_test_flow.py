...
async def test_end_to_end():
    ...
    print("🔍 Step 2: Verifying user exists in DB...")
    user = await fetch_one(
        "SELECT id, full_name, fcm_token FROM users WHERE phone_number = $1", test_phone
    )
    ...
    print("🔔 Step 3: Testing Notification Dispatch...")
    ...
    await notify_user(user_id, "Test Title", "Test Body")
